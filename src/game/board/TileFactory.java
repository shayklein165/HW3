...
public class TileFactory {
    ...
    private Map<Character, Function<Position, Enemy>> InitEnemyList(){
        ...
        map.put('M', (Position position)-> new Boss("The Mountain", 'M', position, 1000, 60, 25, 6, 500, 3));
        map.put('C', (Position position)-> new Boss("Queen Cersei", 'C', position, 100, 10, 10, 1, 1000,8));
        map.put('K', (Position position)-> new Boss("Night's King", 'K', position, 5000, 300, 150, 8, 5000,3));
